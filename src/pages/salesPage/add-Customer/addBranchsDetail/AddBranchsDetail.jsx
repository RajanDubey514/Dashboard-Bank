  ...
  return (
    <div className="bg-white rounded-md p-4 h-full flex flex-col">
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="border border-gray-300 rounded-md px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-indigo-500"
            />
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
              className="bg-yellow-50 border border-gray-300 rounded-md px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-indigo-500"
            />
          </div>
        ...
        {/* Footer Buttons */}
        <div className="flex justify-center gap-3 py-3 mt-2 bg-white sticky bottom-0">
          <button
            type="submit"
