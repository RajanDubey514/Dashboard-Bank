...
const EditBranchsDetail = ({ dataList, setDataList, selectedData, closeEditModal }) => {
  ...
  return (
    <div className="bg-gray-100 rounded-lg flex flex-col h-[75vh]">
      <form onSubmit={formik.handleSubmit} className="flex-1 overflow-y-auto p-4 space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              onChange={formik.handleChange}
              className="bg-yellow-50 border border-gray-300 rounded-md px-2 py-1.5 text-sm outline-none focus:ring-2 focus:ring-indigo-500"
            />
          </div>
          ...
          {/* Other Text Inputs */}
          <div className="flex flex-col">
            <label className="text-sm font-medium text-gray-700">CST No</label>
            <input
              type="text"
              name="cstNo"
