...
import { getUsersDepartment , createUserDepartment } from "../../../../redux/slice/department/DepartmentSlice";
...
const AddDepartment = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      console.log(values)
      try {
       const resp =  await dispatch(createUserDepartment(values)).unwrap();
       console.log(resp)
