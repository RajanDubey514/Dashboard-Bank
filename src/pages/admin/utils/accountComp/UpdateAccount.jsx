...
import { getUsersAccountStatus , updateUserAccountstatus } from "../../../../redux/slice/accountStatus/AccountStatusSlice";
...
const UpdateDepartment = ({selectedData , onClose}) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async(values, { resetForm }) => {
      try {
          console.log(values)
        const resp =  await dispatch(updateUserAccountstatus({
           id: selectedData._id, 
            payload: values,      
        })).unwrap();
