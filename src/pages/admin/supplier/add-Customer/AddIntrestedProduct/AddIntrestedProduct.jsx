      ...
      >
        ...
        <div className="p-2 bg-white flex justify-end gap-4 sticky -bottom-4">
          <button
            type="submit"
            form="addForm"
            className="bg-indigo-600 hover:bg-indigo-700 text-white px-6  rounded-md text-xs font-medium transition"
          >
            Submit
          </button>
          <button
            ...
            className="border border-red-500 text-red-600 hover:bg-red-50 px-6  rounded-md text-xs font-medium transition"
          >
            Reset
          </button>
        </div>
