...
const AddBillOfMaterials = ({ dataList, setDataList }) => {
  ...
  const formik = useFormik({
    initialValues: {
      selectedProduct: "",
      autoProductCode: "", // auto-filled code from selected product
      requiredItemCode: "",
      requiredItemName: "",
      unit: "",
      quantity: "",
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      alertSuccess("Bill of Material saved successfully!");
      resetForm();
    },
  });
  ...
  useEffect(() => {
    ...
    if (selected) {
      ...
      formik.setFieldValue("requiredItemCode", selected.productCode);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                value={formik.values.requiredItemCode}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                className="border border-gray-300 rounded-md px-3 py-2 text-sm"
              />
              {formik.touched.requiredItemCode && formik.errors.requiredItemCode && (
                <p className="text-xs text-red-500">{formik.errors.requiredItemCode}</p>
              )}
            </div>
...
export default AddBillOfMaterials;
