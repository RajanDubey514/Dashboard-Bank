...
// Updated products DB
const productsDB = [
  { itemCode: "P001", description: "Laptop", rate: 50000, sgst: 9, cgst: 9, igst: 0 },
  { itemCode: "P002", description: "Mouse", rate: 500, sgst: 9, cgst: 9, igst: 0 },
  { itemCode: "P003", description: "Laptop1", rate: 52000, sgst: 9, cgst: 9, igst: 0 },
  { itemCode: "P004", description: "Mouse1", rate: 550, sgst: 9, cgst: 9, igst: 0 },
];
...
export default function UpdateInvoice({
  ...
  const addProduct = (product, qty = 1) => {
    setUpProducts((prev) => {
      ...
      return [...prev, { ...product, qty, discountPct: 0, discountAmt: 0 }];
    });
    setScanCode("");
  };
