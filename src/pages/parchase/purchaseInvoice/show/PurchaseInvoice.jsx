...
import { fakePurchaseInvoice } from "../../../../components/FakeData";
...
const PurchaseInvoice = () => {
  ...
  ====================================================== */
  useEffect(() => {
    setDataList(fakePurchaseInvoice);
  }, []);
  ...
  const handleSaveInvoice = () => {
    if (!invoiceData.invoiceNo || products.length === 0) {
  ...
  const handleUpdateInvoice = () => {
    ...
    setDataList(updated);
    Swal.fire("Success", "Purchase Invoice successfully", "success");
