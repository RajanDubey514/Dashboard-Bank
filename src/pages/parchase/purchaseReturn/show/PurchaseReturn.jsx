...
import { fakePurchaseReturn } from "../../../../components/FakeData";
...
const PurchaseReturn = () => {
  ...
  ====================================================== */
  useEffect(() => {
    setDataList(fakePurchaseReturn);
  }, []);
  ...
  const handleSaveInvoice = () => {
    if (!invoiceData.returnNo || products.length === 0) {
    ...
    Swal.fire("Success", "Purchase Return successfully", "success");
