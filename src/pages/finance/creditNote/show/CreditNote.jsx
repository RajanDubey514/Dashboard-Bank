...
import { fakeDebitNote } from "../../../../components/FakeData";

const CreditNote = () => {
  /* =========================
     STATES (SINGLE SOURCE)
  ========================= */
  const [dataList, setDataList] = useState(fakeDebitNote);
  ...
  const handleSaveInvoice = () => {
    ...
    Swal.fire("Success", "Credit Note Added", "success");
  };
  ...
  return (
    <div className="space-y-3 w-full">
      ...
      <div className="flex justify-end gap-3">
        <DownloadDataButton data={tableData} fileName="Bank Entry" />
