        ...
        <table className="w-full table-auto border-collapse text-sm sm:text-base">
          ...
          <thead className="bg-gray-500 text-white uppercase text-xs sticky top-0 z-20">
            <tr>
              ...
              {!hideAction && (
                <th className="px-2 py-1 text-center font-semibold border border-gray-500 sticky right-0 bg-gray-600 z-50">
                  Action
                </th>
              )}
            </tr>
              ...
              rows.map((row, rowIndex) => (
                ...
                >
                  {headers.map((header, colIndex) => (
                    <td
                      key={colIndex}
                      className={`px-2 py-2 border border-gray-200 text-gray-800 text-sm truncate max-w-[220px] 
